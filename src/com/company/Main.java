...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Constants zmienne = new Constants(100, 10, 100.0, 500, 500, 5, 200000, 100, 0.2, 545.0, 2.1, 2.1, 0.9, 499.55, 0.9,5,true,100);
        Constants zmienne2 = new Constants(100, 10, 100.0, 500, 500, 5, 2000000, 100, 0.2, 545.0, 2.1, 2.1, 0.9, 499.55, 0.9,5,false,100);
