...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Constants zmienne = new Constants(100, 10, 150, 3, 3, 10000, 0.2, 545, 2.1, 2.1, 0.1, 0.95, 0.9);
        Position pozycja = new Position(15.0, 15.0, 100.0);
        ...
        PhotonX fotonX = new PhotonX(pozycja, wspkier, komorka, zmienne.massAttenuationCoefficientOfXray, 1);
